...
public class ConfigBuilder {
    ...
    private void handlerPackage(TemplateConfig template, String outputDir, PackageConfig config) {
        ...
        packageInfo.put(ConstVal.VM, joinPackage(config.getParent(), config.getVm()));
        packageInfo.put(ConstVal.MAPPER, joinPackage(config.getParent(), config.getMapper()));
        packageInfo.put(ConstVal.DTO_MAPPER, joinPackage(config.getParent(), config.getDtoMapper()));
        ...
        if (null != configPathInfo) {
            ...
            setPathInfo(pathInfo, template.getVm(), outputDir, ConstVal.VM_PATH, ConstVal.VM);
            setPathInfo(pathInfo, template.getMapper(), outputDir, ConstVal.MAPPER_PATH, ConstVal.MAPPER);
            setPathInfo(pathInfo, template.getDto(), outputDir, ConstVal.DTO_MAPPER_PATH, ConstVal.DTO_MAPPER);
    ...
    private List<TableInfo> processTable(List<TableInfo> tableList, NamingStrategy strategy, StrategyConfig config) {
        ...
        for (TableInfo tableInfo : tableList) {
            ...
            if (StringUtils.isNotEmpty(globalConfig.getDtoMapperName())) {
                tableInfo.setDtoMapperName(String.format(globalConfig.getDtoMapperName(), entityName));
            } else {
                tableInfo.setDtoMapperName(entityName + ConstVal.DTO_MAPPER);
            }
