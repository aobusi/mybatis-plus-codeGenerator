...
public interface ConstVal {
    ...
    String DTO_MAPPER_PATH = "dto_mapper_path";
    ...
    String TEMPLATE_VM_JAVA = "/templates/vm.java";
    String TEMPLATE_ENTITY_KT = "/templates/entity.kt";
    String TEMPLATE_MAPPER = "/templates/mapper.java";
    String TEMPLATE_DTO_MAPPER = "/templates/dtoMapper.java";
